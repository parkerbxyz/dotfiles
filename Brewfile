...
brew "adr-tools"                    # CLI tool for working with Architecture Decision Records
...
brew "cowsay"                       # Apjanke's fork of the classic cowsay project
...
brew "languagetool"                 # Style and grammar checker
...
brew "tnftp"                        # NetBSD's FTP client
...
brew "artginzburg/tap/sudo-touchid" # Permanent TouchID support for sudo
...
cask "languagetool-desktop"         # Grammar, spelling and style suggestions in all the writing apps
cask "logseq"                       # Privacy-first, open-source platform for knowledge sharing and management
cask "lookaway"                     # Break time reminder app
